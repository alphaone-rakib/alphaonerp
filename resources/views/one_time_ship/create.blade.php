...
@component('components.breadcrumb')
        ...
        @slot('title') @lang('Create One Time Ship To')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('one-time-ship-to.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="contact"  class="form-control @error('contact') is-invalid @enderror" type="text" name="contact" value="{{ old('contact') }}" placeholder="@lang('Type Your Contact')" required>
                                    @error('contact')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="save_as"  class="form-control @error('save_as') is-invalid @enderror" type="text" name="save_as" value="{{ old('save_as') }}" placeholder="@lang('Save as')">
                                    @error('save_as')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="ship_to"  class="form-control @error('ship_to') is-invalid @enderror" type="text" name="ship_to" value="{{ old('ship_to') }}" placeholder="@lang('Type Your Ship To')">
                                    @error('ship_to')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="postal_code" class="form-control @error('postal_code') is-invalid @enderror" type="text" name="postal_code" value="{{ old('postal_code') }}" placeholder="@lang('Type Your Postal Code')">
                                    @error('postal_code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="tax_liability" class="form-control @error('tax_liability') is-invalid @enderror" type="text" name="tax_liability" value="{{ old('tax_liability') }}" placeholder="@lang('Type Your Tax Liability')">
                                    @error('tax_liability')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>

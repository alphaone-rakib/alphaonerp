...
<title>@lang('Log in') | ERP :: alphaonerp.com</title>
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <p class="mt-5 fs-20 fw-medium">ERP</p>
                        <p class="mt-3 fs-15 fw-medium">Enterprise Resource Planning</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> ERP. Crafted with <i class="mdi mdi-heart text-danger"></i> by alphaone</p>
                    </div>
                </div>
            </div>
        </div>

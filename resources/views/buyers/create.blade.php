...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Create Buyer')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('buyer.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input id="person_contact"  class="form-control @error('person_contact') is-invalid @enderror" type="text" name="person_contact" value="{{ old('person_contact') }}" placeholder="@lang('Type Your First & Last Name')" readonly>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input id="buyer_email"  class="form-control @error('buyer_email') is-invalid @enderror" type="email" name="buyer_email" value="{{ old('buyer_email') }}" placeholder="@lang('Type Your Email Address')" required>
                                    @error('buyer_email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>

...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Create Customer Group')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('customer-group.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">@lang('Customer Group Create Information')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input id="percentage_rate" class="form-control @error('percentage_rate') is-invalid @enderror" type="number" name="percentage_rate" value="{{ old('percentage_rate') }}" placeholder="@lang('Type Your Discount Percentage Rate')">

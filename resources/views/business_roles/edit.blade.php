...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Edit Business Role')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('business-role.update', $businessRole) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">@lang('Business Role Edit Information')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="role_id" class="form-control @error('role_id') is-invalid @enderror" type="text" name="role_id" value="{{ old('role_id',$businessRole->role_id) }}" placeholder="@lang('Type Your Business Role Id')" required>
                                    @error('role_id')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="name" class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name',$businessRole->name) }}" placeholder="@lang('Type Your Business Role Name')" required>
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="description" class="form-control" name="description" rows="3" placeholder="@lang('Type Your Plant Description')">{{ $businessRole->description }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="enabled" class="form-label">@lang('Status') <b
                                    ...
                                    <select id="enabled" class="form-control @error('enabled') is-invalid @enderror"
                                        ...
                                        <option value="1"
                                            {{ old('enabled', $businessRole->enabled) == 1 ? 'selected' : '' }}>
                                            @lang('Active')</option>
                                        <option value="0"
                                            {{ old('enabled', $businessRole->enabled) == 0 ? 'selected' : '' }}>

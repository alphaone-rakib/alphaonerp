...
@section('title') @lang('Line Edit')  @endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Edit Line')  @endslot
    @endcomponent

    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('line.update', $line) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">@lang('Edit Line')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="part_id" class="form-control @error('part_id') is-invalid @enderror select2" name="part_id" required>
                                        ...
                                        <option value="{{ $value->id }}" {{ old('part_id', $line->part_id) == $value->id ? 'selected' : '' }} >{{ $value->part_number }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="description"  class="form-control @error('description') is-invalid @enderror" type="text" name="description" value="{{ old('description', $line->description) }}" placeholder="@lang('Type Your Description')" required>
                                    @error('description')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="customer_id" class="form-control @error('customer_id') is-invalid @enderror select2" name="customer_id" required>
                                        ...
                                        <option value="{{ $key }}" {{ old('customer_id', $line->customer_id) == $key ? 'selected' : '' }} >{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('customer_id')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                <fieldset class="custom-border p-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="order_quantity"  class="form-control @error('order_quantity') is-invalid @enderror" type="text" name="order_quantity" value="{{ old('order_quantity', $line->order_quantity) }}" placeholder="@lang('Type Your Order Quantity')">
                                        ...
                                        <div class="col-md-2">
                                            <select id="order_quantity_type" class="form-control @error('order_quantity_type') is-invalid @enderror" name="order_quantity_type">
                                                <option value="EA" {{ old('order_quantity_type', $line->order_quantity_type) == 'EA' ? 'selected' : '' }} >@lang('EA')</option>
                                                <option value="BX" {{ old('order_quantity_type', $line->order_quantity_type) == 'BX' ? 'selected' : '' }}>@lang('BX')</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="excepted_quantity"  class="form-control @error('excepted_quantity') is-invalid @enderror" type="text" name="excepted_quantity" value="{{ old('excepted_quantity', $line->excepted_quantity) }}" placeholder="@lang('Type Your Excepted Quantity')" required>
                                        ...
                                        <div class="col-md-2">
                                            <select id="excepted_quantity_type" class="form-control @error('excepted_quantity_type') is-invalid @enderror" name="excepted_quantity_type" required>
                                                <option value="EA" {{ old('excepted_quantity_type', $line->excepted_quantity_type) == 'EA' ? 'selected' : '' }}>@lang('EA')</option>
                                                <option value="BX" {{ old('excepted_quantity_type', $line->excepted_quantity_type) == 'BX' ? 'selected' : '' }}>@lang('BX')</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <input id="best_case_percentage"  class="form-control @error('best_case_percentage') is-invalid @enderror" type="text" name="best_case_percentage" value="{{ old('best_case_percentage', $line->best_case_percentage) }}" placeholder="@lang('0.00')">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <input id="worst_case_percentage"  class="form-control @error('worst_case_percentage') is-invalid @enderror" type="text" name="worst_case_percentage" value="{{ old('worst_case_percentage', $line->worst_case_percentage) }}" placeholder="@lang('0.00')">
                                                <span class="input-group-text">%</span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <input id="confidence_percentage"  class="form-control @error('confidence_percentage') is-invalid @enderror" type="text" name="confidence_percentage" value="{{ old('confidence_percentage', $line->confidence_percentage) }}" placeholder="@lang('0.00')">
                                                <span class="input-group-text">%</span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <select id="price_per" class="form-control select2 @error('price_per') is-invalid @enderror" name="price_per">
                                                <option value="1" {{ old('price_per', $line->price_per) == '1' ? 'selected' : '' }}>@lang('/1')</option>
                                                <option value="10" {{ old('price_per', $line->price_per) == '10' ? 'selected' : '' }}>@lang('/10')</option>
                                                <option value="100" {{ old('price_per', $line->price_per) == '100' ? 'selected' : '' }}>@lang('/100')</option>
                                                <option value="1000" {{ old('price_per', $line->price_per) == '1000' ? 'selected' : '' }}>@lang('/1000')</option>
                                            </select>
                                            @error('price_per')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="unit_price"  class="form-control @error('unit_price') is-invalid @enderror" type="text" name="unit_price" value="{{ old('unit_price', $line->unit_price) }}" placeholder="@lang('Type Your Unit Price')" required>
                                            @error('unit_price')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-check pt-2">
                                                <input class="form-check-input " type="checkbox" id="override_price_list" name="override_price_list" value="1" @if($line->override_price_list) checked @endif>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <input id="discount_percentage"  class="form-control @error('discount_percentage') is-invalid @enderror" type="text" name="discount_percentage" value="{{ old('discount_percentage', $line->discount_percentage) }}" placeholder="@lang('0.00')">
                                                <span class="input-group-text">%</span>
                                        ...
                                        <div class="col-md-4">
                                            <input id="discount_value"  class="form-control @error('discount_value') is-invalid @enderror" type="text" name="discount_value" value="{{ old('discount_value', $line->discount_value) }}" placeholder="@lang('Type Your Discount Value')">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check pt-2">
                                                <input class="form-check-input " type="checkbox" id="override_discount_price_list" name="override_discount_price_list" value="1" @if($line->override_discount_price_list) checked @endif>
                            ...
                            <div class="col-md-6">
                                <fieldset class="custom-border p-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <select id="price_group" class="form-control @error('price_group') is-invalid @enderror select2" name="price_group">
                                                ...
                                                <option value="{{ $key }}" {{ old('price_group', $line->price_group) == $key ? 'selected' : '' }} >{{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('price_group')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="pricing_quantity"  class="form-control @error('pricing_quantity') is-invalid @enderror" type="text" name="pricing_quantity" value="{{ old('pricing_quantity', $line->pricing_quantity) }}" placeholder="@lang('Type Your Pricing Quantity')">
                                        ...
                                        <div class="col-md-2">
                                            <select id="pricing_quantity_type" class="form-control @error('pricing_quantity_type') is-invalid @enderror" name="pricing_quantity_type">
                                                <option value="EA" {{ old('pricing_quantity_type', $line->pricing_quantity_type) == 'EA' ? 'selected' : '' }}>@lang('EA')</option>
                                                <option value="BX" {{ old('pricing_quantity_type', $line->pricing_quantity_type) == 'BX' ? 'selected' : '' }}>@lang('BX')</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="extended_price"  class="form-control @error('extended_price') is-invalid @enderror" type="text" name="extended_price" value="{{ old('extended_price', $line->extended_price) }}" placeholder="@lang('0.00')">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="potential"  class="form-control @error('potential') is-invalid @enderror" type="text" name="potential" value="{{ old('potential', $line->potential) }}" placeholder="@lang('0.00')">
                                            @error('potential')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="misc_charges"  class="form-control @error('misc_charges') is-invalid @enderror" type="text" name="misc_charges" value="{{ old('misc_charges', $line->misc_charges) }}" placeholder="@lang('Type Your Misc Charges')">
                                            @error('misc_charges')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="tax"  class="form-control @error('tax') is-invalid @enderror" type="text" name="tax" value="{{ old('tax', $line->tax) }}" placeholder="@lang('Type Your Tax')">
                                            @error('tax')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="total"  class="form-control @error('total') is-invalid @enderror" type="text" name="total" value="{{ old('total', $line->total) }}" placeholder="@lang('Type Your Total')" required>
                                            @error('total')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="best_case_value"  class="form-control @error('best_case_value') is-invalid @enderror" type="text" name="best_case_value" value="{{ old('best_case_value', $line->best_case_value) }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="worst_case_value"  class="form-control @error('worst_case_value') is-invalid @enderror" type="text" name="worst_case_value" value="{{ old('worst_case_value', $line->worst_case_value) }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="excepted_value"  class="form-control @error('excepted_value') is-invalid @enderror" type="text" name="excepted_value" value="{{ old('excepted_value', $line->excepted_value) }}">

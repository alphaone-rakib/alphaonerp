...
@section('title') @lang('Company Configuration') @endsection
@section('css')
<!--datatable css-->
...
@slot('li_1') @lang('Company Configuration') @endslot
@slot('title') @lang('Company Configuration List') @endslot
@endcomponent
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">@lang('Company Configuration List')</h4>
                    ...
                    <table class="table table-striped compact table-width" id="laravel_datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href=" {{ route('company-configuration.show', $item) }}" type="button" class="btn btn-outline-info waves-effect waves-light shadow-none">@lang('View')</a>&nbsp;&nbsp;
                                    <a href=" {{ route('company-configuration.edit', $item) }}" type="button" class="btn btn-outline-warning waves-effect waves-light shadow-none">@lang('Edit')</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>

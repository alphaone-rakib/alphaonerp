...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('plant.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="plant_id"  class="form-control @error('plant_id') is-invalid @enderror" type="text" name="plant_id" value="{{ old('plant_id') }}" placeholder="@lang('Type Your Plant Id')" required>
                                    @error('plant_id')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="name" class="form-control @error('Name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" placeholder="@lang('Type Your Plant Name')" required>
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>

...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Edit Fiscal Calendar')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('fiscal-calendar.update', $fiscalCalendar) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">@lang('Fiscal Calendar Edit Information')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="fiscal_calendar_id"  class="form-control @error('fiscal_calendar_id') is-invalid @enderror" type="text" name="fiscal_calendar_id" value="{{ old('fiscal_calendar_id', $fiscalCalendar->fiscal_calendar_id) }}" placeholder="@lang('Type Your Fiscal Calendar Id')" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="fiscal_calendar_name" class="form-control @error('fiscal_calendar_name') is-invalid @enderror" type="text" name="fiscal_calendar_name" value="{{ old('fiscal_calendar_name', $fiscalCalendar->fiscal_calendar_name) }}" placeholder="@lang('Type Your Fiscal Calendar Name')" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="description" class="form-control" name="description" rows="3" placeholder="@lang('Type Your Fiscal Calendar Description')">{{ $fiscalCalendar->description }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
    ...
    @section('script')
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#fiscal_calendar_start").flatpickr({
                    enableTime: false,
                    dateFormat: "d-m",
                    defaultDate: "{{$fiscalCalendar->fiscal_calendar_start}}"
                });

                $("#fiscal_calendar_end").flatpickr({
                    enableTime: false,
                    dateFormat: "d-m",
                    defaultDate: "{{$fiscalCalendar->fiscal_calendar_end}}"
                });

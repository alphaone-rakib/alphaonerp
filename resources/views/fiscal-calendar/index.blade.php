...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Fiscal Calendar List')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">@lang('Fiscal Calendar List')</h4>
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ route('fiscal-calendar.create') }}" class="btn btn-outline btn-soft-info shadow-none ml-1">+ @lang('Add Fiscal Calendar')</a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fiscal_calendar_id" class="form-control" value="{{ request()->fiscal_calendar_id }}" placeholder="@lang('Fiscal Calendar Id')">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <div class="form-group">
                                                <label>@lang('Fiscal Calendar Name')</label>
                                                <input type="text" name="fiscal_calendar_name" class="form-control" value="{{ request()->fiscal_calendar_name }}" placeholder="@lang('Fiscal Calendar Name')">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            @if(request()->isFilterActive)
                                                <a href="{{ route('fiscal-calendar.index') }}" class="btn btn-soft-secondary ml-1">@lang('Clear')</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-href="{{ route('fiscal-calendar.destroy', $item) }}" class="btn btn-outline-danger waves-effect waves-light shadow-none" data-bs-toggle="modal" data-bs-target="#myModal">@lang('Delete')</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>

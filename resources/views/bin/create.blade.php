...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Create Bin')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('bin.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="name"  class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" placeholder="@lang('Type Your Bin Name')" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-info mb-3">
                                    <br><br>
                                    <input id="inactive" class="form-check-input" type="checkbox" name="inactive" value="{{ true }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="zone"  class="form-control @error('zone') is-invalid @enderror" type="text" name="zone" value="{{ old('zone') }}" placeholder="@lang('Type Your Bin zone')" required>
                                    @error('zone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-info mb-3">
                                    <br><br>
                                    <input id="non_nettable" class="form-check-input" type="checkbox" name="non_nettable" value="{{ true }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="squence"  class="form-control @error('squence') is-invalid @enderror" type="text" name="squence" value="{{ old('squence') }}" placeholder="@lang('Type Your Bin Squence')" required>
                                    @error('squence')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-info mb-3">
                                    <br><br>
                                    <input id="portable" class="form-check-input" type="checkbox" name="portable" value="{{ true }}">

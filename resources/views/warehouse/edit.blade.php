...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('Edit Warehouse')  @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <form class="form-material form-horizontal" action="{{ route('warehouse.update', $warehouse) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">@lang('Warehouse Edit Information')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="warehouse_id"  class="form-control @error('warehouse_id') is-invalid @enderror" type="text" name="warehouse_id" value="{{ old('warehouse_id', $warehouse->warehouse_id) }}" placeholder="@lang('Type Your Warehouse')" required>
                                    @error('warehouse_id')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="name"  class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $warehouse->name) }}" placeholder="@lang('Type Your Warehouse Name')" required>
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="description" class="form-control" name="description" rows="3" placeholder="@lang('Type Your Description')">{{$warehouse->description}}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="address_one"  class="form-control @error('address_one') is-invalid @enderror" type="text" name="address_one" value="{{ old('address_one', $warehouse->address_one) }}" placeholder="@lang('Type Your Address One')" required>
                                    @error('address_one')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="address_two"  class="form-control @error('address_two') is-invalid @enderror" type="text" name="address_two" value="{{ old('address_two', $warehouse->address_two) }}" placeholder="@lang('Type Your Address Two')">
                                    @error('address_two')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="country" class="form-control @error('country') is-invalid @enderror select2" name="country" required>
                                        ...
                                        <option value="{{ $key }}" {{ old('country', $warehouse->country) == $key ? 'selected' : '' }} >{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('country')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="zip_code" class="form-control @error('zip_code') is-invalid @enderror" type="text" name="zip_code" value="{{ old('zip_code', $warehouse->zip_code) }}" placeholder="@lang('Type Your Zip Code')">
                                    @error('zip_code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="manager_name" class="form-control @error('manager_name') is-invalid @enderror" type="text" name="manager_name" value="{{ old('manager_name', $warehouse->manager_name) }}" placeholder="@lang('Type Your Manager Name')">
                                    @error('manager_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            let selectState = {{ $warehouse->state }};
            let selectCity = {{ $warehouse->city }};
            if (countryId) {
                $.ajax({
